...
static struct s_keyinfo keyinfo[] =
    {
    {WK_BackSpace,      {0x18,0x18,0x18,0x18,0x18,0x18,0x18,0x18},NKEY,NKEY}, // 0x08 - Backspace
    {WK_Tab,            {0x28,0x28,0x28,0x28,0x28,0x28,0x28,0x28},NKEY,NKEY}, // 0x09 - Keyboard Tab
    {WK_Linefeed,       {0x36,0x36,0x36,0x36,0x36,0x36,0x36,0x36},NKEY,NKEY}, // 0x0A - Line Feed
    {WK_Return,         {0x56,0x56,0x56,0x56,0x56,0x56,0x56,0x56},NKEY,NKEY}, // 0x0D - Keyboard Return (ENTER)
    {WK_Escape,         {0x10,0x10,0x10,0x10,0x10,0x10,0x10,0x10},NKEY,NKEY}, // 0x1B - Keyboard ESCAPE
    {' ',               {0x78,0x78,0x78,0x78,0x78,0x78,0x78,0x78},NKEY,NKEY}, // 0x20 - Keyboard Spacebar
    {'#',               {0x55,0x16,0x68,0x16,0x55,0x16,0x68,0x16},NKEY,NKEY}, // 0x23 - Keyboard # and ~
    {'\'',              {0x35,0x03,0x58,0x58,0x35,0x03,0x58,0x58},NKEY,NKEY}, // 0x27 - Keyboard ' and @
    {',',               {0x64,0x64,0x64,0x64,0x64,0x64,0x64,0x64},NKEY,NKEY}, // 0x2C - Keyboard , and <
    {'-',               {0x05,0x75,0x05,0x75,0x05,0x75,0x05,0x75},NKEY,NKEY}, // 0x2D - Keyboard - and _
    {'.',               {0x74,0x74,0x74,0x74,0x74,0x74,0x74,0x74},NKEY,NKEY}, // 0x2E - Keyboard . and >
    {'/',               {0x65,0x65,0x65,0x65,0x65,0x65,0x65,0x65},NKEY,NKEY}, // 0x2F - Keyboard / and ?
    {'0',               {0x15,0x04,0x15,0x04,0x15,0x04,0x15,0x04},NKEY,NKEY}, // 0x30 - Keyboard 0 and )
    {'1',               {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00},NKEY,NKEY}, // 0x31 - Keyboard 1 and !
    {'2',               {0x11,0x11,0x11,0x11,0x11,0x11,0x11,0x11},NKEY,NKEY}, // 0x32 - Keyboard 2 and "
    {'3',               {0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01},NKEY,NKEY}, // 0x33 - Keyboard 3 and £
    {'4',               {0x12,0x12,0x12,0x12,0x12,0x12,0x12,0x12},NKEY,NKEY}, // 0x34 - Keyboard 4 and $
    {'5',               {0x02,0x02,0x02,0x02,0x02,0x02,0x02,0x02},NKEY,NKEY}, // 0x35 - Keyboard 5 and %
    {'6',               {0x13,0x05,0x13,0x48,0x13,0x05,0x13,0x48},NKEY,NKEY}, // 0x36 - Keyboard 6 and ^
    {'7',               {0x03,0x13,0x03,0x13,0x03,0x13,0x03,0x13},NKEY,NKEY}, // 0x37 - Keyboard 7 and &
    {'8',               {0x14,0x55,0x14,0x55,0x14,0x55,0x14,0x55},NKEY,NKEY}, // 0x38 - Keyboard 8 and *
    {'9',               {0x04,0x14,0x04,0x14,0x04,0x14,0x04,0x14},NKEY,NKEY}, // 0x39 - Keyboard 9 and (
    {';',               {0x45,NKEY,0x45,0x68,0x45,NKEY,0x45,0x68},NKEY,NKEY}, // 0x3B - Keyboard ; and :
    {'=',               {0x16,0x45,0x48,0x45,0x16,0x45,0x48,0x45},NKEY,NKEY}, // 0x3D - Keyboard = and +
    {'[',               {0x26,0x26,0x26,0x26,0x26,0x26,0x26,0x26},NKEY,NKEY}, // 0x5B - Keyboard [ and {
    {'\\',              {0x06,0x06,0x06,0x06,0x06,0x06,0x06,0x06},NKEY,NKEY}, // 0x5C - Keyboard \ and |
    {']',               {0x46,0x46,0x46,0x46,0x46,0x46,0x46,0x46},NKEY,NKEY}, // 0x5D - Keyboard ] and }
    {'`',               {NKEY,0x35,NKEY,0x35,NKEY,0x35,NKEY,0x35},NKEY,NKEY}, // 0x60 - Keyboard ` and ~
    {'a',               {0x50,0x50,0x50,0x50,0x50,0x50,0x50,0x50},NKEY,NKEY}, // 0x61 - Keyboard a and A
    {'b',               {0x72,0x72,0x72,0x72,0x72,0x72,0x72,0x72},NKEY,NKEY}, // 0x62 - Keyboard b and B
    {'c',               {0x71,0x71,0x71,0x71,0x71,0x71,0x71,0x71},NKEY,NKEY}, // 0x63 - Keyboard c and C
    {'d',               {0x51,0x51,0x51,0x51,0x51,0x51,0x51,0x51},NKEY,NKEY}, // 0x64 - Keyboard d and D
    {'e',               {0x31,0x31,0x31,0x31,0x31,0x31,0x31,0x31},NKEY,NKEY}, // 0x65 - Keyboard e and E
    {'f',               {0x42,0x42,0x42,0x42,0x42,0x42,0x42,0x42},NKEY,NKEY}, // 0x66 - Keyboard f and F
    {'g',               {0x52,0x52,0x52,0x52,0x52,0x52,0x52,0x52},NKEY,NKEY}, // 0x67 - Keyboard g and G
    {'h',               {0x43,0x43,0x43,0x43,0x43,0x43,0x43,0x43},NKEY,NKEY}, // 0x68 - Keyboard h and H
    {'i',               {0x24,0x24,0x24,0x24,0x24,0x24,0x24,0x24},NKEY,NKEY}, // 0x69 - Keyboard i and I
    {'j',               {0x53,0x53,0x53,0x53,0x53,0x53,0x53,0x53},NKEY,NKEY}, // 0x6A - Keyboard j and J
    {'k',               {0x44,0x44,0x44,0x44,0x44,0x44,0x44,0x44},NKEY,NKEY}, // 0x6B - Keyboard k and K
    {'l',               {0x54,0x54,0x54,0x54,0x54,0x54,0x54,0x54},NKEY,NKEY}, // 0x6C - Keyboard l and L
    {'m',               {0x73,0x73,0x73,0x73,0x73,0x73,0x73,0x73},NKEY,NKEY}, // 0x6D - Keyboard m and M
    {'n',               {0x63,0x63,0x63,0x63,0x63,0x63,0x63,0x63},NKEY,NKEY}, // 0x6E - Keyboard n and N
    {'o',               {0x34,0x34,0x34,0x34,0x34,0x34,0x34,0x34},NKEY,NKEY}, // 0x6F - Keyboard o and O
    {'p',               {0x25,0x25,0x25,0x25,0x25,0x25,0x25,0x25},NKEY,NKEY}, // 0x70 - Keyboard p and P
    {'q',               {0x30,0x30,0x30,0x30,0x30,0x30,0x30,0x30},NKEY,NKEY}, // 0x71 - Keyboard q and Q
    {'r',               {0x22,0x22,0x22,0x22,0x22,0x22,0x22,0x22},NKEY,NKEY}, // 0x72 - Keyboard r and R
    {'s',               {0x41,0x41,0x41,0x41,0x41,0x41,0x41,0x41},NKEY,NKEY}, // 0x73 - Keyboard s and S
    {'t',               {0x32,0x32,0x32,0x32,0x32,0x32,0x32,0x32},NKEY,NKEY}, // 0x74 - Keyboard t and T
    {'u',               {0x33,0x33,0x33,0x33,0x33,0x33,0x33,0x33},NKEY,NKEY}, // 0x75 - Keyboard u and U
    {'v',               {0x62,0x62,0x62,0x62,0x62,0x62,0x62,0x62},NKEY,NKEY}, // 0x76 - Keyboard v and V
    {'w',               {0x21,0x21,0x21,0x21,0x21,0x21,0x21,0x21},NKEY,NKEY}, // 0x77 - Keyboard w and W
    {'x',               {0x61,0x61,0x61,0x61,0x61,0x61,0x61,0x61},NKEY,NKEY}, // 0x78 - Keyboard x and X
    {'y',               {0x23,0x23,0x23,0x23,0x23,0x23,0x23,0x23},NKEY,NKEY}, // 0x79 - Keyboard y and Y
    {'z',               {0x70,0x70,0x70,0x70,0x70,0x70,0x70,0x70},NKEY,NKEY}, // 0x7A - Keyboard z and Z
    {WK_Left,           {0x37,0x37,0x37,0x37,0x37,0x37,0x37,0x37},NKEY,NKEY}, // 0x100 - Keyboard Left Arrow
    {WK_Right,          {0x47,0x47,0x47,0x47,0x47,0x47,0x47,0x47},NKEY,NKEY}, // 0x101 - Keyboard Right Arrow
    {WK_Up,             {0x27,0x27,0x27,0x27,0x27,0x27,0x27,0x27},NKEY,NKEY}, // 0x102 - Keyboard Up Arrow
    {WK_Down,           {0x67,0x67,0x67,0x67,0x67,0x67,0x67,0x67},NKEY,NKEY}, // 0x103 - Keyboard Down Arrow
    {WK_Page_Up,        {0x07,0x07,0x07,0x07,0x07,0x07,0x07,0x07},NKEY,NKEY}, // 0x104 - Keyboard Page Up
    {WK_Page_Down,      {0x77,0x77,0x77,0x77,0x77,0x77,0x77,0x77},NKEY,NKEY}, // 0x105 - Keyboard Page Down
    {WK_Home,           {0x57,0x57,0x57,0x57,0x57,0x57,0x57,0x57},NKEY,NKEY}, // 0x106 - Keyboard Home
    {WK_End,            {0x17,0x17,0x17,0x17,0x17,0x17,0x17,0x17},NKEY,NKEY}, // 0x107 - Keyboard End
    {WK_Insert,         {0x76,0x76,0x76,0x76,0x76,0x76,0x76,0x76},NKEY,NKEY}, // 0x108 - Keyboard Insert
    {WK_Delete,         {0x38,0x38,0x38,0x38,0x38,0x38,0x38,0x38},NKEY,NKEY}, // 0x109 - Keyboard Delete Forward
    {WK_Pause,          {0x08,0x08,0x08,0x08,0x08,0x08,0x08,0x08},NKEY,NKEY}, // 0x10A - Keyboard Pause
    {WK_Scroll_Lock,    {SCRL,SCRL,SCRL,SCRL,SCRL,SCRL,SCRL,SCRL},NKEY,NKEY}, // 0x10B - Keyboard Scroll Lock
    {WK_Shift_L,        {0x60,0x60,0x60,0x60,0x60,0x60,0x60,0x60},NKEY,NKEY}, // 0x10D - Left Shift
    {WK_Shift_R,        {0x66,0x66,0x66,0x66,0x66,0x66,0x66,0x66},NKEY,NKEY}, // 0x10E - Right Shift
    {WK_Control_L,      {0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20},NKEY,NKEY}, // 0x10F - Left Control
    {WK_Control_R,      {0x20,0x20,0x20,0x20,0x20,0x20,0x20,0x20},NKEY,NKEY}, // 0x110 - Right Control
    {WK_Caps_Lock,      {0x40,0x40,0x40,0x40,0x40,0x40,0x40,0x40},NKEY,NKEY}, // 0x111 - Keyboard Caps Lock
    {WK_Num_Lock,       {0x07,0x07,0x07,0x07,0x07,0x07,0x07,0x07},NKEY,NKEY}, // 0x113 - Keyboard Num Lock and Clear
    {WK_F1,             {0x09,0x09,0x09,0x09,0x09,0x09,0x09,0x09},NKEY,NKEY}, // 0x120 - Keyboard F1
    {WK_F2,             {0x29,0x29,0x29,0x29,0x29,0x29,0x29,0x29},NKEY,NKEY}, // 0x121 - Keyboard F2
    {WK_F3,             {0x59,0x59,0x59,0x59,0x59,0x59,0x59,0x59},NKEY,NKEY}, // 0x122 - Keyboard F3
    {WK_F4,             {0x79,0x79,0x79,0x79,0x79,0x79,0x79,0x79},NKEY,NKEY}, // 0x123 - Keyboard F4
    {WK_F5,             {0x19,0x19,0x19,0x19,0x19,0x19,0x19,0x19},NKEY,NKEY}, // 0x124 - Keyboard F5
    {WK_F6,             {0x39,0x39,0x39,0x39,0x39,0x39,0x39,0x39},NKEY,NKEY}, // 0x125 - Keyboard F6
    {WK_F7,             {0x49,0x49,0x49,0x49,0x49,0x49,0x49,0x49},NKEY,NKEY}, // 0x126 - Keyboard F7
    {WK_F8,             {0x69,0x69,0x69,0x69,0x69,0x69,0x69,0x69},NKEY,NKEY}, // 0x127 - Keyboard F8
    {WK_F9 ,            {DIAK,DIAK,DIAK,DIAK,DIAK,DIAK,DIAK,DIAK},NKEY,NKEY}, // 0x129 - Keyboard F9 - Diagnostics toggle
    {WK_F10,            {0x36,0x36,0x36,0x36,0x36,0x36,0x36,0x36},NKEY,NKEY}, // 0x128 - Keyboard F10 - MTX Line Feed
    {WK_F11,            {NKEY,NKEY,NKEY,NKEY,NKEY,NKEY,NKEY,NKEY},NKEY,NKEY}, // 0x12A - Keyboard F11
    {WK_F12,            {NUML,NUML,NUML,NUML,NUML,NUML,NUML,NUML},NKEY,NKEY}, // 0x12B - Keyboard F12 - NumLock replacement
    {WK_KP_Left,        {0x37,0x37,0x37,0x37,0x37,0x28,0x37,0x28},NKEY,NKEY}, // 0x130 - Keypad 4 and Left Arrow
    {WK_KP_Right,       {0x47,0x47,0x47,0x47,0x47,0x38,0x47,0x38},NKEY,NKEY}, // 0x131 - Keypad 6 and Right Arrow
    {WK_KP_Up,          {0x27,0x27,0x27,0x27,0x27,0x17,0x27,0x17},NKEY,NKEY}, // 0x132 - Keypad 8 and Up Arrow
    {WK_KP_Down,        {0x67,0x67,0x67,0x67,0x67,0x57,0x67,0x57},NKEY,NKEY}, // 0x133 - Keypad 2 and Down Arrow
    {WK_KP_Page_Up,     {0x38,0x38,0x38,0x38,0x07,0x08,0x07,0x08},NKEY,NKEY}, // 0x134 - Keypad 9 and Page Up
    {WK_KP_Page_Down,   {0x77,0x77,0x77,0x77,0x77,0x47,0x77,0x47},NKEY,NKEY}, // 0x135 - Keypad 3 and PageDn
    {WK_KP_Home,        {0x28,0x28,0x28,0x28,0x57,0x07,0x57,0x07},NKEY,NKEY}, // 0x136 - Keypad 7 and Home
    {WK_KP_End,         {0x76,0x76,0x76,0x76,0x17,0x37,0x17,0x37},NKEY,NKEY}, // 0x137 - Keypad 1 and End
    {WK_KP_Add,         {NKEY,NKEY,NKEY,NKEY,NKEY,0x45,NKEY,0x45},NKEY,NKEY}, // 0x138 - Keypad +
    {WK_KP_Subtract,    {NKEY,NKEY,NKEY,NKEY,0x05,NKEY,0x05,NKEY},NKEY,NKEY}, // 0x139 - Keypad -
    {WK_KP_Multiply,    {0x08,0x08,0x08,0x08,NKEY,0x55,NKEY,0x55},NKEY,NKEY}, // 0x13A - Keypad *
    {WK_KP_Divide,      {0x17,0x17,0x17,0x17,0x65,NKEY,0x65,NKEY},NKEY,NKEY}, // 0x13B - Keypad /
    {WK_KP_Enter,       {NKEY,NKEY,NKEY,NKEY,0x56,0x56,0x56,0x56},NKEY,NKEY}, // 0x13C - Keypad ENTER
    {WK_KP_Middle,      {0x57,0x57,0x57,0x57,0x57,0x27,0x57,0x27},NKEY,NKEY}, // 0x13D - Keypad 5
    {WK_PC_Alt_L,       {RST1,RST1,RST1,RST1,RST1,RST1,RST1,RST1},NKEY,NKEY}, // 0x140 - Left Alt
    {WK_PC_Alt_R,       {RST2,RST2,RST2,RST2,RST2,RST2,RST2,RST2},NKEY,NKEY}, // 0x141 - Right Alt
    {WK_Mac_Cmd_L,      {NKEY,NKEY,NKEY,NKEY,NKEY,NKEY,NKEY,NKEY},NKEY,NKEY}, // 0x143 - Left Meta
    {WK_Mac_Cmd_R,      {NKEY,NKEY,NKEY,NKEY,NKEY,NKEY,NKEY,NKEY},NKEY,NKEY}  // 0x144 - Right Meta
    };
...
static struct
    ...
    word    wk;
    BOOLEAN    bDown;
    } alt_toggle[NUM_ALT_TOGGLE];
static int n_alt_toggle = 0;
static BOOLEAN bToggle = FALSE;
...
void kbd_win_keypress (WIN *win, int wk)
    ...
    if (n_alt_toggle > 0)
        ...
        int nPress = 0;
        for (int i = 0; i < n_alt_toggle; ++i)
            {
            if (wk == alt_toggle[i].wk)
                {
                diag_message (DIAG_KBD_REMAP, "Remap toggle key %d pressed", i);
                alt_toggle[i].bDown = TRUE;
                bPress = TRUE;
                }
            if (alt_toggle[i].bDown) ++nPress;
            }
        if (bPress && (nPress == n_alt_toggle))
            {
            bToggle = ! bToggle;
            diag_message (DIAG_KBD_REMAP, "Remap %s", bToggle ? "Enabled" : "Disabled");
            return;
            }
        }
    pki = kbd_find (wk);
    ...
    if ( pki != NULL )
        ...
        if (bToggle)
            {
            kscan = pki->alt_press;
            diag_message (DIAG_KBD_REMAP, "Alternate scan code = 0x%02X for wk = %d", kscan, wk);
            }
        if (kscan == NKEY) kscan = pki->press[kbd_mode];
        pki->release = kscan;
...
void kbd_win_keyrelease(WIN *win, int wk)
    ...
    if (n_alt_toggle > 0)
        ...
        for (int i = 0; i < n_alt_toggle; ++i)
            ...
            if (wk == alt_toggle[i].wk)
                {
                alt_toggle[i].bDown = FALSE;
                diag_message (DIAG_KBD_REMAP, "Remap toggle key %d released", i);
                break;
                }
            }
        }
...
static byte mtx_key_scan (const char *ps)
    {
    static struct
        {
        const char *psName;
    ...
    if (strlen (ps) == 1)
        ...
        char ch = *ps;
        if ((ch >= 'A') && (ch <= 'Z')) ch += 'a' - 'A';
        struct s_keyinfo *pki = kbd_find (ch);
        if (pki == NULL) return NKEY;
        return pki->press[0];
        }
    for (int i = 0; i < sizeof (mtx_keys) / sizeof (mtx_keys[0]); ++i)
        {
        if (strcasecmp (ps, mtx_keys[i].psName) == 0) return mtx_keys[i].scan;
        }
    return NKEY;
    }

static int wk_num (const char *ps)
    {
    static struct
        {
        const char *psName;
        ...
        {
        {"backspace",       WK_BackSpace},
        {"tab",             WK_Tab},
        {"linefeed",        WK_Linefeed},
        {"return",          WK_Return},
        {"escape",          WK_Escape},
        {"space",           0x20},
        {"left",            WK_Left},
        ...
        {"down",            WK_Down},
        {"page_up",         WK_Page_Up},
        {"page_down",       WK_Page_Down},
        {"home",            WK_Home},
        {"end",             WK_End},
        {"insert",          WK_Insert},
        {"delete",          WK_Delete},
        {"pause",           WK_Pause},
        {"scroll_lock",     WK_Scroll_Lock},
        {"sys_req",         WK_Sys_Req},
        {"shift_l",         WK_Shift_L},
        {"shift_r",         WK_Shift_R},
        {"control_l",       WK_Control_L},
        {"control_r",       WK_Control_R},
        {"caps_lock",       WK_Caps_Lock},
        {"shift_lock",      WK_Shift_Lock},
        {"num_lock",        WK_Num_Lock},
        {"f1",              WK_F1},
        {"f2",              WK_F2},
        {"f3",              WK_F3},
        {"f4",              WK_F4},
        ...
        {"f12",             WK_F12},
        {"kp_left",         WK_KP_Left},
        {"kp_right",        WK_KP_Right},
        {"kp_up",           WK_KP_Up},
        {"kp_down",         WK_KP_Down},
        {"kp_page_up",      WK_KP_Page_Up},
        {"kp_page_down",    WK_KP_Page_Down},
        {"kp_home",         WK_KP_Home},
        {"kp_hnd",          WK_KP_End},
        {"kp_add",          WK_KP_Add},
        {"kp_subtract",     WK_KP_Subtract},
        {"kp_multiply",     WK_KP_Multiply},
        {"kp_divide",       WK_KP_Divide},
        {"kp_enter",        WK_KP_Enter},
        {"kp_middle",       WK_KP_Middle},
        {"pc_windows_l",    WK_PC_Windows_L},
        {"pc_windows_r",    WK_PC_Windows_R},
        {"pc_alt_l",        WK_PC_Alt_L},
        {"pc_alt_r",        WK_PC_Alt_R},
        {"pc_menu",         WK_PC_Menu},
        {"mac_cmd_l",       WK_Mac_Cmd_L},
        {"mac_cmd_r",       WK_Mac_Cmd_R},
        {"mac_alt",         WK_Mac_Alt},
        {"menu",            WK_Menu},
        };
    if (strlen (ps) == 1)
    ...
    for (int i = 0; i < sizeof (wk_names) / sizeof (wk_names[0]); ++i)
        {
        if (strcasecmp (ps, wk_names[i].psName) == 0) return wk_names[i].wk;
        }
    return -1;
    }

static char get_name (FILE *f, char *psName, int nLen)
    {
    char ch;
    int nCh = 0;
    while (TRUE)
    ...
    psName[nCh] = '\0';
    diag_message (DIAG_KBD_REMAP, "get_name = \"%s\", term = 0x%02X", psName, ch);
    return ch;
    }

void kbd_set_alternate (const char *psFile)
    {
    FILE *f = fopen (psFile, "r");
    if (f == NULL) fatal ("Error opening alternate keyboard mapping file");
    diag_message (DIAG_KBD_REMAP, "Reading remap file %s", psFile);
    char sName[32];
    char sMap[32];
    n_alt_toggle = 0;
    for (int i = 0; i < NUM_ALT_TOGGLE; ++i)
        {
        char term = get_name (f, sName, sizeof (sName));
        if (sName[0] == '\0') break;
        alt_toggle[i].wk = wk_num (sName);
        if (alt_toggle[i].wk == -1) fatal ("Invalid alternate keyboard toggle key");
        ++n_alt_toggle;
        diag_message (DIAG_KBD_REMAP, "Remap toggle key %d = %s (%d)", i, sName, alt_toggle[i].wk);
        if (term == '\n') break;
        }
    while (TRUE)
        {
        ...
        int wk = wk_num (sName);
        struct s_keyinfo *pki = kbd_find (wk);
        if (pki == NULL) fatal ("Invalid host key name for alternate keyboard mapping");
        term = get_name (f, sMap, sizeof (sMap));
        pki->alt_press = mtx_key_scan (sMap);
        if (pki->alt_press == NKEY) fatal ("Invalid MTX key name for alternate keyboard mapping");
        diag_message (DIAG_KBD_REMAP, "Map keyboard key %s (%d) to MTX key %s (%d)", sName, wk, sMap, pki->alt_press);
        while (term != '\n')
            {
            if (term == EOF) return;
            term = fgetc (f);
    ...
    fclose (f);
    diag_message (DIAG_KBD_REMAP, "Alternate keyboard mapping configured");
    }
